package com.db.circularanimateddrawable.widgets;
...
import com.db.circularanimateddrawable.R;
import com.db.circularanimateddrawable.drawables.CircularRevealAnimatedDrawable;
import com.db.circularanimateddrawable.interfaces.AnimatedButton;
import com.db.circularanimateddrawable.interfaces.OnAnimationEndListener;

import customlibraries.db.com.circularanimateddrawable.CircularAnimatedDrawable;
...
public class CircularProgressButton extends PathwayButton implements AnimatedButton {
    ...
    /**
     * Initializes all the views and components used.
     *
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs == null) {
            mGradientDrawable = (GradientDrawable) getDrawable(getContext(), R.drawable.bg_btn_selector);
        } else {
     ...
     * @param context
     * @param attrs
     * @see #init(Context, AttributeSet, int, int)
     */
    ...
    /**
     * This method is called when the button and its dependencies are going to draw themselves.
     *
     * @param canvas Canvas
     * @see #drawIndeterminateProgress(Canvas)
     * @see #drawDoneAnimation(Canvas)
     */
    @Override
    ...
    /**
     * If the mAnimatedDrawable is null or its not running, it gets created. Otherwise its draw() method is
     * called here.
     *
     * @param canvas Canvas
     */
    ...
    /**
     * Method called on onDraw, when the button is on DONE status
     *
     * @param canvas Canvas
     */
     ...
     * Defines the shape of the circle as well.
     */
    ...
    /**
     * Reverts the animation and the button is restored back to its original form
     */
    @SuppressLint("NewApi")
    @Override
    public void revertAnimation(final OnAnimationEndListener onAnimationEndListener) {
        ...
        setBackground(getResources().getDrawable(R.drawable.bg_btn_selector));
        mAnimatorSet = new AnimatorSet();
        mAnimatorSet.setDuration(300);
        mAnimatorSet.playTogether(cornerAnimation, widthAnimation, heightAnimation);
        mAnimatorSet.addListener(new AnimatorListenerAdapter() {
